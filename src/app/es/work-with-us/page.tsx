...
const trades = ['Techado', 'Drywall', 'Pintura', 'Pisos', 'Mano de Obra General', 'Concreto', 'Plomeria', 'Electricidad', 'HVAC', 'Otro']
const crewSizes = ['1-5', '6-10', '11-20', '20+']
const projectSizes = ['Menos de 50K', '50K a 250K', '250K a 1M', '1M+']
const availabilities = ['Disponible Ahora', '30 Dias', '60+ Dias']
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center px-6 pt-24 pb-16">
        <div className="max-w-lg text-center">
          ...
          <h1 className="font-display text-4xl font-bold text-slate-900 uppercase mb-4">Solicitud Recibida</h1>
          <p className="text-slate-500 mb-2">Gracias, {form.contactName}. Hemos recibido su solicitud y la revisaremos pronto.</p>
          <p className="text-slate-400 text-sm mb-8">Los subcontratistas aprobados seran contactados a medida que esten disponibles los proyectos.</p>
    ...
    <div className="min-h-screen bg-slate-50 pt-24 pb-16">
      <div className="max-w-3xl mx-auto px-6">
        <div className="text-center mb-4">
          ...
          <p className="text-slate-500 mt-3 max-w-lg mx-auto">Pro-Line Builders trabaja con subcontratistas calificados en Florida y Nashville. Envie su informacion para ser considerado en proyectos proximos.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-sm border border-gray-100 p-8 shadow-sm">
          ...
          {step === 1 && (<div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div><label className="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-3">Tamano del Equipo *</label><div className="space-y-2">
              ...
              <div><label className="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-3">Tamano Tipico de Proyecto *</label><div className="space-y-2">
          ...
          {step === 4 && (<div className="space-y-6">
            ...
            <div className="bg-slate-50 rounded-sm p-4 space-y-2">
              ...
              <div className="flex justify-between text-sm"><span className="text-slate-500">Telefono</span><span className="font-semibold text-slate-900">{form.phone}</span></div>
              ...
              {form.serviceArea && <div className="flex justify-between text-sm"><span className="text-slate-500">Area de Servicio</span><span className="font-semibold text-slate-900">{form.serviceArea}</span></div>}
            </div>
            <div className="bg-slate-50 rounded-sm p-4 space-y-2">
              ...
              <div className="flex justify-between text-sm"><span className="text-slate-500">Tamano del Equipo</span><span className="font-semibold text-slate-900">{form.crewSize}</span></div>
              <div className="flex justify-between text-sm"><span className="text-slate-500">Tamano Tipico</span><span className="font-semibold text-slate-900">{form.typicalProjectSize}</span></div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-sm p-4 text-sm text-blue-800"><p>Los subcontratistas aprobados seran contactados a medida que esten disponibles los proyectos en Florida y Nashville.</p></div>
            <button type="submit" disabled={submitting} className="w-full bg-blue-700 hover:bg-blue-800 disabled:bg-blue-400 text-white font-bold py-4 rounded-sm uppercase text-sm tracking-wider transition-all flex items-center justify-center gap-2">{submitting ? 'Enviando...' : <>Enviar Solicitud <ArrowRight className="w-4 h-4" /></>}</button>
          </div>)}
          <div className="flex justify-between mt-8 pt-6 border-t border-gray-100">
            {step > 0 ? <button type="button" onClick={back} className="flex items-center gap-2 text-slate-500 hover:text-slate-700 font-semibold text-sm uppercase tracking-wider"><ArrowLeft className="w-4 h-4" /> Atras</button> : <div />}
