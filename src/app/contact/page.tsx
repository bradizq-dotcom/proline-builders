              ...
              <div className="bg-white border border-gray-100 rounded-sm p-8 shadow-sm">
                ...
                {submitted ? (
                  <div className="py-16 text-center">
                    ...
                    <h3 className="font-display text-2xl font-bold text-slate-900 uppercase mb-2">Message Sent!</h3>
                    <p className="text-slate-500 mb-6">Thanks, {form.name}. We'll be in touch within 24 hours.</p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex items-center justify-between pt-2 gap-4">
                      ...
                      <button type="submit" disabled={submitting}
                        className="flex items-center gap-2 bg-blue-700 hover:bg-blue-800 text-white px-8 py-3 rounded-sm font-bold text-sm uppercase tracking-wider transition-all disabled:opacity-50 whitespace-nowrap">
