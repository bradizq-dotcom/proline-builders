...
const phases = [
  {
    number: '01',
    title: 'DRONE SURVEY & ASSESSMENT',
    timeline: '1–3 Days',
    items: [
      'Aerial drone survey of roofs and building exteriors',
      'Photo documentation and condition report',
      'Scope review with your management team',
  ...
  },
  {
    ...
    items: [
      ...
      'Timeline built around your occupancy',
  ...
  },
  {
    ...
    items: [
      ...
      'Municipality and HOA coordination',
      'Vetted subcontractor scheduling',
  ...
  },
  {
    ...
    items: [
      ...
      'Crews coordinated across buildings',
      'Photo documentation throughout the job',
      'Tenant-conscious scheduling and communication',
    ],
  },
  {
    number: '05',
